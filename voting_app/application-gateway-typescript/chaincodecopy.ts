...
export class AssetTransferContract extends Contract {
    ...
    public async CreateSession(ctx: Context, sessionID: string, sessionName: string, sessionInformation:string, 
        endTime:string, options: Option[]): Promise<void> {
    ...
    @Transaction()
    public async UpdateSession(ctx: Context, id: string, status: string): Promise<void> {
        ...
        const updatedAsset = {
            sessionID: oldAsset.sessionID,
            sessionName: oldAsset.sessionName,
            startTime: oldAsset.startTime,
            endTime: oldAsset.endTime,
            status: status,
            sessionInformation: oldAsset.sessionInformation,
            options: oldAsset.options, 
        };
